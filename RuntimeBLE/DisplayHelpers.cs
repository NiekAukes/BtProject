...
namespace RuntimeBLE
{
    ...
    /// </summary>
    public sealed class BluetoothLEDeviceDisplay : INotifyPropertyChanged
    {
    ...
    /// </summary>
    public enum GattNativeServiceUuid : uint
    {
        None = 0,
    ...
    /// </summary>
    public enum GattNativeCharacteristicUuid : uint
    {
        None = 0,
    ...
    /// </summary>
    public enum GattNativeDescriptorUuid : uint
    {
    ...
    public static class Utilities
    {
        ...
        /// <returns></returns>
        public static uint ConvertUuidToShortId(Guid uuid)
        {
            // Get the short Uuid
            var bytes = uuid.ToByteArray();
            var shortUuid = (uint) (bytes[0] | (bytes[1] << 8));
            return shortUuid;
        }
